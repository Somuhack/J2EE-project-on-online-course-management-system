<%-- 
    Document   : AddCourse
    Created on : 24 Nov, 2023, 11:14:06 PM
    Author     : somna
--%>
...
<html>
    <head>
        ...
        <script >
            ...
            function checkImg()
            {
                if (document.getElementById('imgout').src === "C:\Users\somna\Documents\NetBeansProjects\OC") //change this path to your project path
                {
    ...
    <body>
        <form onsubmit="return validate()" method="POST" action="http://localhost:8080/OC/AddCourse" enctype="multipart/form-data">
            <div class="container">
                <h1>Add Course To Database</h1>
                <label for="name">Name:</label>
                <input type="text" id="name" name="cname" onblur="checkName()">
                <label for="fa">Fees Amount:</label>
                <input type="text" id="fa" name="cfee" >
                <label for="cdu">Course Duration(In Months):</label>
                <input type="text" id="cdu" name="cdu" >
                <label for="cd">Course Description :</label>
                <textarea id="cd" name="cdes" rows="4" cols="50"></textarea>
                ...
                <div >
                    ...
                    %>
                    <br>
                    <button  type="submit" name="submit" id="done">Add Course</button><br><br>
                    <a href="http://localhost:8080/OC/admin.html"<button>Go Back</button></a>
