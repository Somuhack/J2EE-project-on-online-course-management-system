      ...
      <tr>
        <%
                       for(counter = 1; counter <= orsmd.getColumnCount(); counter ++)
                        ...
                        %>
                        <td><a href="http://localhost:8080/OC/EditStudent.jsp?email=<%=ors.getString(2)%>"<button>Edit</button>
              <a href="http://localhost:8080/OC/delStudent?id=<%=ors.getString(2)%>"<button>Delete</button></a></td>
      </tr>
      <%
                    }
                    %>
