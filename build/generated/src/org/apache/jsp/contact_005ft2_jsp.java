...
public final class contact_005ft2_jsp extends org.apache.jasper.runtime.HttpJspBase
    ...
    try {
      ...
      out.write("        ");
        ...
        ("jdbc:oracle:thin:@Asus_ROG_G15:1521:orcl","TIITA","DATABASE");
            ...
            ops = (OraclePreparedStatement)oconn.prepareCall("select * from contacts");
      ...
      out.write("\n");
      out.write("                        <td><a href=\"updateContact.jsp?id=");
      out.print(ors.getString(3));
      out.write("\"<button>Edit</button></a>\n");
      out.write("                            <a href=\"http://localhost:8080/OC/deleteCon?id=");
      out.print(ors.getString(3));
