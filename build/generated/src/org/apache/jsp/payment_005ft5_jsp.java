...
public final class payment_005ft5_jsp extends org.apache.jasper.runtime.HttpJspBase
    ...
    try {
      ...
      out.write("        ");
        ...
        ("jdbc:oracle:thin:@Asus_ROG_G15:1521:orcl","TIITA","DATABASE");
            ...
            ops = (OraclePreparedStatement)oconn.prepareCall("select * from PAYMENTS");
      ...
      out.write("\n");
      out.write("                        <td><a href=\"http://localhost:8080/OC/delPayment?id=");
      ...
      out.write("<footer align=\"center\"><a href=\"http://localhost:8080/OC/admin.html\"<button>Go Back</button></a></footer>\n");
      out.write("    </body>\n");
      out.write("</html>");
    } catch (Throwable t) {
