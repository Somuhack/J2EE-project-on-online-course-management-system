...
public final class student_005fdetails_005ft3_jsp extends org.apache.jasper.runtime.HttpJspBase
    ...
    try {
      ...
      out.write("        ");
        ...
        ("jdbc:oracle:thin:@Asus_ROG_G15:1521:orcl","TIITA","DATABASE");
            ...
            ops = (OraclePreparedStatement)oconn.prepareCall("select * from STUDENT_DETAILS");
      ...
      out.write("\n");
      out.write("        <td><button>Edit</button>  <a href=\"http://localhost:8080/OC/delStudentDetails?cid=");
      out.print(ors.getString(11));
