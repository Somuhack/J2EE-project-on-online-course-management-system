...
public class delStudentDetails extends HttpServlet 
{
    String SEMAIL;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            SEMAIL = request.getParameter("cid");
        ...
        ("jdbc:oracle:thin:@Asus_ROG_G15:1521:orcl","TIITA","DATABASE");
                ...
                ops = (OraclePreparedStatement)  oconn.prepareCall("DELETE FROM student_details WHERE S_EMAIL_ID = ?");
                ...
                rs = ops.executeQuery();
                  ...
                  {  
                        ...
                        RequestDispatcher rd1=request.getRequestDispatcher("./student_details_t3.jsp");  
...
//                        pw.println("</form>");  
                  ...
                  {  
                        ...
                        RequestDispatcher rd2=request.getRequestDispatcher("./student_details_t3.jsp");  
