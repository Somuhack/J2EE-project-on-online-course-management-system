...
public class deleteCon extends HttpServlet 
{
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        ("jdbc:oracle:thin:@Asus_ROG_G15:1521:orcl","TIITA","DATABASE");
                ...
                ops = (OraclePreparedStatement)  oconn.prepareCall("DELETE FROM Contacts WHERE SEMAIL = ?");
                ...
                rs = ops.executeQuery();
                  ...
                  {  
                        ...
                        RequestDispatcher rd1=request.getRequestDispatcher("./contact_t2.jsp");  
...
//                        pw.println("</form>");  
                  ...
                  {  
                        ...
                        RequestDispatcher rd2=request.getRequestDispatcher("./contact_t2.jsp");  
