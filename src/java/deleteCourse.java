...
public class deleteCourse extends HttpServlet 
{
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        ("jdbc:oracle:thin:@Asus_ROG_G15:1521:orcl","TIITA","DATABASE");
                ...
                ops = (OraclePreparedStatement)  oconn.prepareCall("DELETE FROM Courses WHERE C_ID = ?");
                ...
                rs = ops.executeQuery();
                  ...
                  {  
                        ...
                        RequestDispatcher rd1=request.getRequestDispatcher("./course_t4.jsp");  
...
//                        pw.println("</form>");  
                  ...
                  {  
                        pw.println("<center><h3>some error here...</h3></center>");  
                        RequestDispatcher rd2=request.getRequestDispatcher("./course_t4.jsp");  
